"""
Django settings for rutgers_test_47470 project.
...
ROOT_URLCONF = 'rutgers_test_47470.urls'
...
WSGI_APPLICATION = 'rutgers_test_47470.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rutgers_test_47470 API",
    "DESCRIPTION": "API documentation for rutgers_test_47470 App",
    "VERSION": "v1",
}
